...
func TestPost_ReportsEvaluationSummary(t *testing.T) {
	...
	AssertAggregatorPost(t, agg, "evaluation_summary", []interface{}{map[string]interface{}{"key": "my-test-key", "type": "CONFIG", "value": "my-test-value", "value_type": "string", "count": 1, "reason": 2, "summary": map[string]interface{}{"config_row_index": 0, "conditional_value_index": 1}}, map[string]interface{}{"key": "my-string-list-key", "type": "CONFIG", "value": []interface{}{"a", "b", "c"}, "value_type": "string_list", "count": 1, "reason": 1, "summary": map[string]interface{}{"config_row_index": 0, "conditional_value_index": 0}}, map[string]interface{}{"key": "feature-flag.integer", "type": "FEATURE_FLAG", "value": 3, "value_type": "int", "count": 2, "reason": 2, "summary": map[string]interface{}{"config_row_index": 0, "conditional_value_index": 1}}, map[string]interface{}{"key": "feature-flag.weighted", "type": "FEATURE_FLAG", "value": 2, "value_type": "int", "count": 1, "reason": 3, "summary": map[string]interface{}{"config_row_index": 0, "conditional_value_index": 0, "weighted_value_index": 2}}}, "/api/v1/telemetry")
}
